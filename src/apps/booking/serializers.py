...
class BookingSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if date_time[0]['date_start'] != date_time[0]['date_end'] and (date_time[0]['start_time'] or date_time[0]['end_time']):
            raise exceptions.ValidationError

        if date_time[0]['date_start'] == date_time[0]['date_end'] and date_time[0]['start_time'] is not None and date_time[0]['start_time'] == date_time[0]['end_time']:
            raise exceptions.ValidationError
